/*
  # Fix User Achievements Table Migration

  1. New Tables
    - Ensures `user_achievements` table exists
    - Stores user achievements and viewed status
  
  2. Security
    - Enables RLS on the table
    - Adds policy for users to manage their own achievements
    - Adds index for better query performance
  
  3. Triggers
    - Adds trigger to automatically update the updated_at column
*/
