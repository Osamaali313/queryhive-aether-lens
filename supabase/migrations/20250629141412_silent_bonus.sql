/*
# Learning System and Knowledge Base Schema

1. New Tables
   - `learning_patterns` - Stores AI learning patterns for personalization
   - `user_feedback` - Collects user feedback for reinforcement learning
   - `knowledge_base` - Stores knowledge entries with vector embeddings
...
3. Performance
   ...
   - Add vector search capabilities for knowledge base
*/
